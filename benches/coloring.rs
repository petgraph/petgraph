...
use petgraph::{algo::coloring::recursive_largest_first_coloring, prelude::*};
use test::Bencher;

use petgraph::algo::dsatur_coloring;

#[bench]
fn rlf_coloring_bench(bench: &mut Bencher) {
    ...
    bench.iter(|| {
        let _scores = recursive_largest_first_coloring(&g);
    });
}
