...
impl<N: Copy + Eq + Hash, E> DiGraph<N, E>
{
    ...
    pub fn nodes<'a>(&'a self) -> DiGraphNodes<'a, N, E>
    {
        DiGraphNodes{iter: self.nodes.keys()}
    }
...
pub struct DiGraphNodes<'a, N: 'a, E: 'a> {
    iter: Keys<'a, N, Vec<(N, E)>>
}

impl<'a, N: 'a, E: 'a> Iterator<&'a N> for DiGraphNodes<'a, N, E>
{
